...
/**
 *
 * CustomModalGraphMouse is a PluggableGraphMouse class that
 ...
 *
 * @author Tom Nelson
 * Modified by Florian Werkl
 */
public class CustomModalGraphMouse<V,E> extends AbstractModalGraphMouse
        implements ModalGraphMouse, ItemSelectable
{
     ...
     */
    public CustomModalGraphMouse(float in, float out) {
        super(in,out);
        loadPlugins();
        //setModeKeyListener(new edu.uci.ics.jung.visualization.control.CustomModalGraphMouse.ModeKeyAdapter(this));
    }
    ...
    protected void loadPlugins()
    {
        ...
        translatingPlugin = new CustomGraphMousePlugin<V,E>();
